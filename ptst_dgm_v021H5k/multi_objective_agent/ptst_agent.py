...
from ptst_dgm_v021H5k.agent.archive import PatchTSTAgentEntry, HORIZONS
from ptst_dgm_v021H5k.multi_objective_agent.ptst_sampler import PatchTSTSampler, PARAM_BOUNDS
            ...
            for attempt in range(max_retries):
                try:
                    ...
                    if parsed and self._validate(parsed):
                        # Add fixed Architecture, LoRA, and seed=None to LLM result (v0.2.1H5k)
                        from ptst_dgm_v021H5k.multi_objective_agent.ptst_sampler import FIXED_ARCH_PARAMS, FIXED_LORA_PARAMS
