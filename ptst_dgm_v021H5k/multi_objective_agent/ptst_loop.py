...
from ptst_dgm_v021H5k.agent.archive import PatchTSTAgentEntry, PatchTSTArchive, HORIZONS, OBJECTIVE_KEYS
from ptst_dgm_v021H5k.agent.evaluator import PatchTSTEvaluator
from ptst_dgm_v021H5k.multi_objective_agent.ptst_agent import PatchTSTMultiObjectiveAgent
from ptst_dgm_v021H5k.multi_objective_agent.pareto_archive import ParetoArchive
    ...
    def run(self, dry_run: bool = False) -> None:
        ...
        for t in range(1, self.total_budget + 1):
            ...
            if pareto_parent:
                ...
                print(f"  30d: α={params['focal_alpha_30d']:.3f} γ={params['focal_gamma_30d']:.3f} w_n={params['w_normal_30d']:.3f} w_a={params['w_anomal_30d']:.3f}")
                print(f"  60d: α={params['focal_alpha_60d']:.3f} γ={params['focal_gamma_60d']:.3f} w_n={params['w_normal_60d']:.3f} w_a={params['w_anomal_60d']:.3f}")
                print(f"  90d: α={params['focal_alpha_90d']:.3f} γ={params['focal_gamma_90d']:.3f} w_n={params['w_normal_90d']:.3f} w_a={params['w_anomal_90d']:.3f}")
                print(f"  Arch: patch={params['patch_len']} stride={params['stride']}  LoRA: r={params['lora_rank']} α={params['lora_alpha']}")
                ...
                parent = PatchTSTAgentEntry.create_child(
                    ...
                    focal_alpha_30d=params['focal_alpha_30d'],
                    focal_gamma_30d=params['focal_gamma_30d'],
                    w_normal_30d=params['w_normal_30d'],
                    w_anomal_30d=params['w_anomal_30d'],
                    focal_alpha_60d=params['focal_alpha_60d'],
                    focal_gamma_60d=params['focal_gamma_60d'],
                    w_normal_60d=params['w_normal_60d'],
                    w_anomal_60d=params['w_anomal_60d'],
                    focal_alpha_90d=params['focal_alpha_90d'],
                    focal_gamma_90d=params['focal_gamma_90d'],
                    w_normal_90d=params['w_normal_90d'],
                    w_anomal_90d=params['w_anomal_90d'],
                ...
                print(f"  30d: α={parent.focal_alpha_30d:.3f} γ={parent.focal_gamma_30d:.3f} w_n={parent.w_normal_30d:.3f} w_a={parent.w_anomal_30d:.3f}")
                print(f"  60d: α={parent.focal_alpha_60d:.3f} γ={parent.focal_gamma_60d:.3f} w_n={parent.w_normal_60d:.3f} w_a={parent.w_anomal_60d:.3f}")
                print(f"  90d: α={parent.focal_alpha_90d:.3f} γ={parent.focal_gamma_90d:.3f} w_n={parent.w_normal_90d:.3f} w_a={parent.w_anomal_90d:.3f}")
                print(f"  Arch: patch={parent.patch_len} stride={parent.stride}  LoRA: r={parent.lora_rank} α={parent.lora_alpha}")
            else:
            ...
            focal_alpha_30d = proposal["focal_alpha_30d"]
            focal_gamma_30d = proposal["focal_gamma_30d"]
            w_normal_30d    = proposal["w_normal_30d"]
            w_anomal_30d    = proposal["w_anomal_30d"]
            focal_alpha_60d = proposal["focal_alpha_60d"]
            focal_gamma_60d = proposal["focal_gamma_60d"]
            w_normal_60d    = proposal["w_normal_60d"]
            w_anomal_60d    = proposal["w_anomal_60d"]
            focal_alpha_90d = proposal["focal_alpha_90d"]
            focal_gamma_90d = proposal["focal_gamma_90d"]
            w_normal_90d    = proposal["w_normal_90d"]
            w_anomal_90d    = proposal["w_anomal_90d"]
            ...
            print(f"[Proposal] 30d: α={focal_alpha_30d:.3f} γ={focal_gamma_30d:.3f} w_n={w_normal_30d:.3f} w_a={w_anomal_30d:.3f}")
            print(f"[Proposal] 60d: α={focal_alpha_60d:.3f} γ={focal_gamma_60d:.3f} w_n={w_normal_60d:.3f} w_a={w_anomal_60d:.3f}")
            print(f"[Proposal] 90d: α={focal_alpha_90d:.3f} γ={focal_gamma_90d:.3f} w_n={w_normal_90d:.3f} w_a={w_anomal_90d:.3f}")
            print(f"[Proposal] Arch: patch={patch_len} stride={stride}  LoRA: r={lora_rank} α={lora_alpha}{seed_info}")
            ...
            is_pareto = self.pareto.add(
                {
                    "focal_alpha_30d": focal_alpha_30d,
                    "focal_gamma_30d": focal_gamma_30d,
                    "w_normal_30d": w_normal_30d,
                    "w_anomal_30d": w_anomal_30d,
                    "focal_alpha_60d": focal_alpha_60d,
                    "focal_gamma_60d": focal_gamma_60d,
                    "w_normal_60d": w_normal_60d,
                    "w_anomal_60d": w_anomal_60d,
                    "focal_alpha_90d": focal_alpha_90d,
                    "focal_gamma_90d": focal_gamma_90d,
                    "w_normal_90d": w_normal_90d,
                    "w_anomal_90d": w_anomal_90d,
                    "patch_len": patch_len,
                    "stride": stride,
                    "lora_rank": lora_rank,
