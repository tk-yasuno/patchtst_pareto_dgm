# init_baseline.ps1
# Train PatchTST baseline with v0.2.1H configuration, then initialize the DGM archive.
#
# v0.2.1H baseline uses:
...
#   .\ptst_dgm_v021H\scripts\init_baseline.ps1
...
$INIT_SCRIPT  = "ptst_dgm_v021H\scripts\init_baseline_archive.py"
$EVAL_JSON    = Join-Path $ArchiveDir "baseline_eval.json"
$OUTPUT_DIR   = Join-Path $ArchiveDir "baseline_model"

Write-Host "===== PatchTST DGM v0.2.1H - Baseline Initialisation =====" -ForegroundColor Cyan
