...
# Configuration
PARETO_FILE = "ptst_dgm_v021/results/ptst_archive_v021_pareto.jsonl"
OUTPUT_DIR = "ptst_dgm_v021/results/visualizations_v021_pareto"
...
def print_summary(solutions):
    ...
    print("\n" + "="*80)
    print("Pareto Frontier Summary (PatchTST Multi-Objective DGM v0.2.1H)")
    print("="*80)
    ...
    print(f"  - Parameters (horizon-specific):")
    print(f"    30d: α={best_f1['params']['focal_alpha_30d']:.3f}, γ={best_f1['params']['focal_gamma_30d']:.3f}, "
          f"w_n={best_f1['params']['w_normal_30d']:.3f}, w_a={best_f1['params']['w_anomal_30d']:.3f}")
    print(f"    60d: α={best_f1['params']['focal_alpha_60d']:.3f}, γ={best_f1['params']['focal_gamma_60d']:.3f}, "
          f"w_n={best_f1['params']['w_normal_60d']:.3f}, w_a={best_f1['params']['w_anomal_60d']:.3f}")
    print(f"    90d: α={best_f1['params']['focal_alpha_90d']:.3f}, γ={best_f1['params']['focal_gamma_90d']:.3f}, "
          f"w_n={best_f1['params']['w_normal_90d']:.3f}, w_a={best_f1['params']['w_anomal_90d']:.3f}")
    
    print(f"\nBest Mean FPR: {best_fpr['mean_fpr']:.4f} (Trial #{best_fpr['trial_number']})")
    print(f"  - Macro F1: {best_fpr['macro_f1']:.4f}")
    print(f"  - Parameters (horizon-specific):")
    print(f"    30d: α={best_fpr['params']['focal_alpha_30d']:.3f}, γ={best_fpr['params']['focal_gamma_30d']:.3f}, "
          f"w_n={best_fpr['params']['w_normal_30d']:.3f}, w_a={best_fpr['params']['w_anomal_30d']:.3f}")
    print(f"    60d: α={best_fpr['params']['focal_alpha_60d']:.3f}, γ={best_fpr['params']['focal_gamma_60d']:.3f}, "
          f"w_n={best_fpr['params']['w_normal_60d']:.3f}, w_a={best_fpr['params']['w_anomal_60d']:.3f}")
    print(f"    90d: α={best_fpr['params']['focal_alpha_90d']:.3f}, γ={best_fpr['params']['focal_gamma_90d']:.3f}, "
          f"w_n={best_fpr['params']['w_normal_90d']:.3f}, w_a={best_fpr['params']['w_anomal_90d']:.3f}")
...
def main():
    ...
    # Note: Parameter space and heatmap plots disabled for v0.2.1H (9D parameters)
