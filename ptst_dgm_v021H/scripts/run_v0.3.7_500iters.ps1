# v0.3.7: Architecture Optimization with Model Checkpointing
# - Same strategy as v0.3.6 (2D Architecture, seed=42 fixed)
# - NEW: Save best model every 100 iterations
# - Budget: 500 iterations
# - Checkpoint interval: 100 iterations (5 checkpoints total)

Write-Host "=" -ForegroundColor Cyan
Write-Host "v0.3.7: Architecture Optimization + Checkpoint Strategy" -ForegroundColor Cyan
Write-Host "=" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  - Checkpoint: Every 100 iterations" -ForegroundColor White
...
Write-Host "  - Saves best model every 100 iterations" -ForegroundColor White
Write-Host "  - No more 'lost best model' incidents" -ForegroundColor White
Write-Host "  - 5 checkpoints → models/v0.3.7_checkpoints/" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "Starting v0.3.7 DGM run..." -ForegroundColor Cyan
Write-Host "Expected duration: ~4-5 hours" -ForegroundColor Gray
Write-Host ""
...
Write-Host ""
Write-Host "=" -ForegroundColor Cyan
Write-Host "v0.3.7 Complete!" -ForegroundColor Green
Write-Host "=" -ForegroundColor Cyan
...
if (Test-Path "models\v0.3.7_checkpoints\*.pt") {
    Get-ChildItem models\v0.3.7_checkpoints\*.pt | Sort-Object Name | ForEach-Object {
    ...
    # Find overall best
    $allCheckpoints = Get-ChildItem models\v0.3.7_checkpoints\*.json | ForEach-Object {
...
Write-Host "  1. Review results: ptst_dgm/results/ptst_archive_v0.3.7_log.jsonl" -ForegroundColor White
...
Write-Host "  4. Create result report: RESULT_v0.3.7.md" -ForegroundColor White
Write-Host ""
