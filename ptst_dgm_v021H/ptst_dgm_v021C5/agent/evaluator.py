...
class PatchTSTEvaluator:
    ...
    def evaluate(
        ...
        """Train PatchTST with given 8D params + seed and return 15 objective values."""
        ...
        print(f"[Evaluator] Running: α={focal_alpha:.3f} γ={focal_gamma:.3f} "
              f"w_n={w_normal:.3f} w_a={w_anomal:.3f} patch={patch_len} stride={stride} "
              f"lora_r={lora_rank} lora_α={lora_alpha} {seed_info}")
